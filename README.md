...
-- Reduce the lines of code in a function based on its responsiblity. Not to do too many things at one place
-- Understand the requirement properly and write code. Dont try to include unneccessary handlings
-- write more tests to cover the code branches
-- Remove deadcode or unwanted code**
